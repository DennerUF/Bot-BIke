module.exports = {
    ...
    selectItem: `Digite o número da opção que deseja retirar do seu carrinho`,
    namesBike:`1. Dropp Z1-X\n2. Caloi Andes\n`,
    fallback:`Desculpe, não entendi. Para retirar do carrinho, eu preciso do número de uma das opções abaixo:\n 1. Dropp Z1-X\n2. Caloi Andes\n`,
    bikes:[
        {
          "id": 1,
          "name": "Dropp Z1-X",
