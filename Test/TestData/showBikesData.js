    ...
    fullcard:{
        ...
        content: {
          ...
          buttons: [
            {
              type: 'imBack',
              value: 'Mais Informacoes sobre a bicicleta',
              title: 'Mais Informacoes sobre a bicicleta',
              channelData: undefined
            },
            {
              type: 'imBack',
              value: 'Ver Proxima opção de bicicleta',
              title: 'Ver Proxima opção de bicicleta',
              channelData: undefined
            },
            {
              type: 'imBack',
